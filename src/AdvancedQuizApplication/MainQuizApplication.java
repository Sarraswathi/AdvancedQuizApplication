...
public class MainQuizApplication {
    ...
    public static void main(String[] args) {
        ...
        MultipleChoiceQuestion q1 = new BasicQuestion(
                "Which keyword is used to define a class in Java?",
                new String[]{"new", "class", "Class", "define"},
                1
        );

        MultipleChoiceQuestion q2 = new BasicQuestion(
                "Which data type is used to store decimal values?",
                new String[]{"int", "double", "char", "boolean"},
                1
        );

        MultipleChoiceQuestion q3 = new AdvanceQuestion(
        ...
        MultipleChoiceQuestion q4 = new AdvanceQuestion(
                "Which loop executes at least once?",
                new String[]{"for loop", "while loop", "do-while loop", "none"},
                2
        );

        MultipleChoiceQuestion q5 = new BasicQuestion(
